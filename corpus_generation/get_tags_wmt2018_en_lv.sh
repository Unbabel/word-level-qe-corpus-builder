#!/bin/bash
#
# This generates the alignment data for WMT2018 latvian data. Here different
# preprocessig was used to train the aligner and some additional work is
# neccesary to generate the alignments
#
